...
def save_run_dets(*, run_category):
    global mqttc
    ...
    rec = {"table__": "runs", "run_id": run_id, "run_category": run_category, "created_ts": time.time(), "host": host, "pid": pid, "argv0": sys.executable, "args": " ".join(sys.argv), "run_label": run_label}
